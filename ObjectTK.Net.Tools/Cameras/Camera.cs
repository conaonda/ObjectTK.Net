...
namespace ObjectTK.Net.Tools.Cameras
{
    public class Camera
    {
        ...
        private void UpdateFrame(OpenTK.Windowing.Common.FrameEventArgs e)
        {
            Behavior.UpdateFrame(State, (float) e.Time * MoveSpeed);
        }

        private void MouseMove(OpenTK.Windowing.Common.MouseMoveEventArgs e)
        {
            Behavior.MouseMove(State, MouseMoveSpeed * new Vector2(e.DeltaX, e.DeltaY));
        }
        
        private void MouseWheelChanged(OpenTK.Windowing.Common.MouseWheelEventArgs e)
        {
