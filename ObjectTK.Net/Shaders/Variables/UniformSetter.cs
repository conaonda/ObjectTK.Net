    ...
    internal abstract class UniformSetter
    {
        ...
        static UniformSetter()
        {
            Setters = new List<UniformSetter>
            {
                ...
                new Map<float[]>((_, values) => GL.Uniform1(_, values.Length, values)),
                ...
                new Map<Color4[]>((_, values) => GL.Uniform4(_, values.Length, values.SelectMany(c => new float[]{c.R, c.G, c.B, c.A }).ToArray())),
